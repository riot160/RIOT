// IMPORTANT: Load crypto at the VERY FIRST line
...
app.post('/api/pair', async (req, res) => {
    ...
    if (!cleanNumber.startsWith('254') && !cleanNumber.startsWith('1') && !cleanNumber.startsWith('44')) {
    ...
    try {
        ...
        const sock = makeWASocket({
            auth: state,
            browser: ['RIOT MD', 'Chrome', '120.0.0.0'],
